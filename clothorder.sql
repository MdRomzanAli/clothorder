...
('Md.Romzan Ali', 'romzan@gmail.com', '01751566156', 'ra', ''),
...
INSERT INTO `cloth` (`F_ID`, `name`, `price`, `description`, `R_ID`, `images_path`, `options`) VALUES

(59, 't shirt', 40, 't shirt', 1, 'images/product-1.jpg', 'ENABLE');
...
('romzan', 'Md. Romzan Ali', 'romzan@gmail.com', '01751566156', 'dhaka', '12345');
...
INSERT INTO `orders` (`order_ID`, `F_ID`, `clothname`, `price`, `quantity`, `order_date`, `username`, `R_ID`) VALUES
...
--
ALTER TABLE `cloth`
  ADD CONSTRAINT `cloth_ibfk_1` FOREIGN KEY (`R_ID`) REFERENCES `shop` (`R_ID`);

--
-- Constraints for table `orders`
--
ALTER TABLE `orders`
  ADD CONSTRAINT `orders_ibfk_1` FOREIGN KEY (`F_ID`) REFERENCES `cloth` (`F_ID`),
