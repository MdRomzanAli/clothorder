...
<?php
  ...
  ?>
           <ul class="nav navbar-nav navbar-right">
            ...
            <li><a href="clothlist.php">MENU </a></li>
...
$gtotal = 0;
  foreach($_SESSION["cart"] as $keys => $values)
  {
    ...
    $F_ID = $values["cloth_id"];
    $clothname = $values["cloth_name"];
    $quantity = $values["cloth_quantity"];
    $price =  $values["cloth_price"];
    $total = ($values["cloth_quantity"] * $values["cloth_price"]);
    $R_ID = $values["R_ID"];
    ...
    $gtotal = $gtotal + $total;
     ...
     $query = "INSERT INTO ORDERS (F_ID, clothname, price,  quantity, order_date, username, R_ID) 
              VALUES ('" . $F_ID . "','" . $clothname . "','" . $price . "','" . $quantity . "','" . $order_date . "','" . $username . "','" . $R_ID . "')";
      ...
      if(!$success)
      {
        ...
        <br>
<h1 class="text-center">Grand Total: Taka=<?php echo "$gtotal"; ?></h1>
<h5 class="text-center" style="display: none;">including all service charges. (no delivery charges applied)</h5>
<br>
<h1 class="text-center">
  <a href="cart.php"><button class="btn btn-warning" style="display: none;"><span class="glyphicon glyphicon-circle-arrow-left"></span> Go back to cart</button></a>
  <a href="onlinepay.php"><button class="btn btn-success " style="display: none;"><span class="glyphicon glyphicon-credit-card"></span> Pay Online</button></a>
  <a href="COD.php"><button class="btn btn-success"></span> Cash On Delivery</button></a>
</h1>
        ...
        <div class="row">
            ...
            <div class="col-lg-2 col-12">
                ...
                <div class="d-flex flex-column flex-wrap">
                    ...
                    <a href="#" class="font-rale font-size-14 text-white-50 pb-1">Feedbacks</a>
                </div>
            </div>
        </div>
    </div>
